    ...
    <div class="row mb-1 g-1">
        <div class="col-md-6">
            <input type="text" wire:model.live.debounce.300ms="search" class="form-control"
                placeholder="{{ __('dashboard.search') }} ({{ __('dashboard.governorate') }})">
        </div>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex align-items-center gap-2 flex-wrap">
                                ...
                                <a href="{{ route('dashboard.governorates.regions', $item) }}"
                                    class="btn btn-sm btn-info">
                                    <i class="fa-regular fa-pen-to-square"></i>
                                    {{ __('dashboard.manage-regions') }}
                                </a>
                            </div>
                        </td>
                        ...
                        <td style="min-width: 180px;">
                            <div class="d-flex gap-1">
                                <button type="button" class="btn btn-sm btn-primary"
                                    title="{{ __('dashboard.update-governorate') }}"
                                    wire:click="editGovernorate({{ $item->id }})">
