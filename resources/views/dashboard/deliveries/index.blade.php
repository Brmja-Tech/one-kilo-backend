@extends('dashboard.master', ['title' => 'Delivery'])
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <button type="button" class="btn btn-primary waves-effect" data-bs-toggle="modal"
                        ...
                        <i class="fa-solid fa-plus"></i> {{ __('dashboard.create-delivery') }}
                    </button>
                    @livewire('dashboard.deliveries.user-create')
                </div>
                <div class="card-body">
                    @livewire('dashboard.deliveries.user-data')
                </div>
            </div>
        </div>
    </div>
